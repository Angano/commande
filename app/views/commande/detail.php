        ...
        <div class="card col-12 col-sm-11 mx-auto mt-3 p-0">   
                <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between my-2">
                            ...
                            <div>
                                <?php if($datas['commande']['livraison_status']==='1'){ ?>
                                La commande est livrée. Vous pouvez modier le status.
                                <?php }?>
                            </div>
                            <div class="d-flex justify-content-end">
                                    
                                    <div class="me-2">
                                        <b>Valider la livraison</b>:&nbsp;&nbsp;
...
<?php if(count($datas['commandes'])>0 && $datas['commande']['livraison_status']!=='1'){ ?>
...
if($datas['commandes'] && $datas['commande']['livraison_status']!=='1'){ ?> 
    <div class="row mt-3 py-3">
        <div class="col-md-11 mx-auto">
            <h4>Livraison en attente dans un rayon de <?= $datas['limite']?> km pour d'autre client</h4>
            <span class="btn btn-sm btn-primary" id="showOhersCommandes">Show</span>
        </div>
    </div>

    <div id="display_other_commandes" style="display:none">
        <?php
